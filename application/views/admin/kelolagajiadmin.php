      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-sm-12">
            <div class="page-title-box">
              ...
              <div class="col">
                <h2 style="float:left">Kelola Gaji</h2>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-12">
              <div class="card">
                  <div class="card-body">
                      <h4 class="mt-0 header-title">Data Gaji SME-Branding</h4>
                      <p class="text-muted font-14">Berikut adalah data-data gaji admin sme-branding
                      </p>
                      <br>
