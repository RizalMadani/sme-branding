      ...
      <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
        ...
        <a href="javascript:void(0);" class="dropdown-item notify-item">
          <div class="notify-icon">
            <img src="<?= base_url(); ?>assets/admin/images/users/avatar-2.jpg" alt="user-img" class="img-fluid rounded-circle"/>
          </div>
        ...
        <a href="javascript:void(0);" class="dropdown-item notify-item">
          <div class="notify-icon">
            <img src="<?= base_url(); ?>assets/admin/images/users/avatar-3.jpg" alt="user-img" class="img-fluid rounded-circle"
            /> </div>
          <p class="notify-details">
            <b>Thomas J. Mimms</b>
