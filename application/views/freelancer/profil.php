              ...
              <div class="card m-b-30">
                  <div class="card-body">
                      ...
                      <div class="general-label">
                          <form action="<?=base_url()?>freelancer/Profil/updateProfil" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group bmd-form-group">
                                ...
                                <select class="form-control" name="kategori">
                                    <option value="<?=$freelancer->kategori_keahlian?>"><?=$freelancer->kategori_keahlian?></option>
                              ...
                              <div class="form-group bmd-form-group">
                                ...
                                <textarea name="keterangank" class="form-control" rows="8" cols="80"><?=$freelancer->keterangan?></textarea>
                              </div>
