          ...
          <div class="col-md-12 col-xl-3">
            <div class="card m-b-30 border-0">
              ...
              <div class="card-body  text-center">
                <img src="<?= base_url(); ?>assets/admin/images/users/avatar-5.jpg" alt="" class="rounded-circle mx-auto d-block w-25">
                ...
                <div class="table-responsive">
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img class="" src="<?= base_url(); ?>assets/admin/images/products/pro1.png" alt="user" width="40"> </td>
                        <td>
                          Chair
                        </td>
                        <td>
                          <img src="<?= base_url(); ?>assets/admin/images/flags/us_flag.jpg" alt="" width="30">
                        </td>
                      ...
                      <tr>
                        <td>
                          <img class="" src="<?= base_url(); ?>assets/admin/images/products/pro2.png" alt="user" width="40"> </td>
                        <td>
                          Mobile
                        </td>
                        <td>
                          <img src="<?= base_url(); ?>assets/admin/images/flags/french_flag.jpg" alt="" width="30">
                        </td>
                      ...
                      <tr>
                        <td>
                          <img class="" src="<?= base_url(); ?>assets/admin/images/products/pro3.png" alt="user" width="40"> </td>
                        <td>
                          LED
                        </td>
                        <td>
                          <img src="<?= base_url(); ?>assets/admin/images/flags/spain_flag.jpg" alt="" width="30">
                        </td>
                      ...
                      <tr>
                        <td>
                          <img class="" src="<?= base_url(); ?>assets/admin/images/products/pro4.png" alt="user" width="40"> </td>
                        <td>
                          Chair
                        </td>
                        <td>
                          <img src="<?= base_url(); ?>assets/admin/images/flags/russia_flag.jpg" alt="" width="30">
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="<?= base_url(); ?>assets/admin/images/flags/italy_flag.jpg" alt="" width="30">
                        </td>
                ...
                <div class="table-responsive">
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img class="rounded-circle" src="<?= base_url(); ?>assets/admin/images/users/avatar-2.jpg" alt="user" width="40"> </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img class="rounded-circle" src="<?= base_url(); ?>assets/admin/images/users/avatar-3.jpg" alt="user" width="40"> </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img class="rounded-circle" src="<?= base_url(); ?>assets/admin/images/users/avatar-4.jpg" alt="user" width="40"> </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img class="rounded-circle" src="<?= base_url(); ?>assets/admin/images/users/avatar-5.jpg" alt="user" width="40"> </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <img class="rounded-circle" src="<?= base_url(); ?>assets/admin/images/users/avatar-6.jpg" alt="user" width="40"> </td>
                        <td>
                          <a href="javascript:void(0);">Ruby T. Curd</a>
                        </td>
                        <td>
              ...
              <div class="card-body">
                <div class="owl-carousel">
                  <div class="owl-inner row">
                    <div class="col-2">
                      <img src="<?= base_url(); ?>assets/admin/images/users/avatar-1.jpg" alt="" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-10">
                  ...
                  <div class="owl-inner row">
                    <div class="col-2">
                      <img src="<?= base_url(); ?>assets/admin/images/users/avatar-2.jpg" alt="" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-10">
                      <p>"Lorem Ipsum is simply dummy text of the and typesetting industry. A
                        list is perfect for defining terms."</p>
                  ...
                  <div class="owl-inner row">
                    <div class="col-2">
                      <img src="<?= base_url(); ?>assets/admin/images/users/avatar-3.jpg" alt="" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-10">
                      <p>"Lorem Ipsum is simply dummy text of the and typesetting industry. A
                        list is perfect for defining terms."</p>
                  ...
                  <div class="owl-inner row">
                    <div class="col-2">
                      <img src="<?= base_url(); ?>assets/admin/images/users/avatar-4.jpg" alt="" class="img-fluid rounded-circle">
                    </div>
                    <div class="col-10">
                      <p>"Lorem Ipsum is simply dummy text of the and typesetting industry. A
                        list is perfect for defining terms."</p>
