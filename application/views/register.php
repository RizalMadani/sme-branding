            ...
            <div class="px-3">
              <div class="row">
                ...
                <a href="<?=base_url()?>Registrasi">
                    <button class="btn btn-light btn-raised btn-block waves-effect" style="color:black">UMKM</button>
                </a>
                <a href="<?=base_url()?>Registrasi/regFreelancer">
                    <button class="btn btn-warning btn-raised btn-block waves-effect waves-light">Freelancer</button>
                </a>
              </center>
              </div>

              <?= form_open(base_url('Auth/regUMKM'), ['name' => 'form-login', 'class' => 'form-horizontal']) ?>
